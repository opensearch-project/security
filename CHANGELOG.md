...
- Bump `org.springframework.kafka:spring-kafka-test` from 3.3.4 to 3.3.6 ([#5315](https://github.com/opensearch-project/security/pull/5315), [#5352](https://github.com/opensearch-project/security/pull/5352))
