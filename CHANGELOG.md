...
- Bump `ch.qos.logback:logback-classic` from 1.5.21 to 1.5.25 ([#5888](https://github.com/opensearch-project/security/pull/5888), [#5902](https://github.com/opensearch-project/security/pull/5902), [#5912](https://github.com/opensearch-project/security/pull/5912))
