...
- Bump `org.opensearch:protobufs` from 0.6.0 to 0.18.0 ([#5553](https://github.com/opensearch-project/security/pull/5553), [#5662](https://github.com/opensearch-project/security/pull/5662))
