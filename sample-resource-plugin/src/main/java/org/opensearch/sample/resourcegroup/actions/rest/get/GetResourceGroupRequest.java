 ...
 */
public class GetResourceGroupRequest extends ActionRequest implements DocRequest {
     ...
     * Default constructor
     */
    public GetResourceGroupRequest(String resourceId) {
        this.resourceId = resourceId;
    }

    public GetResourceGroupRequest(StreamInput in) throws IOException {
