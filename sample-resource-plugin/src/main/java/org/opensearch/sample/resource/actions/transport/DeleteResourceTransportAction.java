 ...
 */
public class DeleteResourceTransportAction extends HandledTransportAction<DeleteResourceTransportAction.Request, DeleteResourceTransportAction.Response> {
    ...
    public DeleteResourceTransportAction(TransportService transportService, ActionFilters actionFilters, PluginClient pluginClient) {
        super(DeleteResourceAction.NAME, transportService, actionFilters, Request::new);
    ...
    protected void doExecute(Task task, Request request, ActionListener<Response> listener) {
        ...
        ActionListener<DeleteResponse> deleteResponseListener = ActionListener.wrap(deleteResponse -> {
            if (deleteResponse.getResult() == DocWriteResponse.Result.NOT_FOUND) {
                ...
                listener.onResponse(new Response("Resource " + resourceId + " deleted successfully."));
            }
        }, exception -> {
