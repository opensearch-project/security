 ...
 */
public class GetResourceTransportAction extends HandledTransportAction<GetResourceTransportAction.Request, GetResourceTransportAction.Response> {
    ...
    public GetResourceTransportAction(TransportService transportService, ActionFilters actionFilters, PluginClient pluginClient) {
        super(GetResourceAction.NAME, transportService, actionFilters, Request::new);
    ...
    /**
     * Response to a GetSampleResource request
     */
