...
@RunWith(Suite.class)
@Suite.SuiteClasses({
    RACFeatureDisabledSystemIndexEnabledTests.ApiAccessTests.class,
    RACFeatureDisabledSystemIndexEnabledTests.DirectIndexAccessTests.class })
public class RACFeatureDisabledSystemIndexEnabledTests {
