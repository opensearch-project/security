...
### Maintenance
* Bump com.nimbusds:nimbus-jose-jwt from 9.37.3 to 9.39 ([#4337](https://github.com/opensearch-project/security/pull/4337))
* Bump Wandalen/wretry.action from 3.4.0 to 3.5.0 ([#4335](https://github.com/opensearch-project/security/pull/4335))
* Bump com.nimbusds:nimbus-jose-jwt from 9.39 to 9.39.1 ([#4353](https://github.com/opensearch-project/security/pull/4353))
* Bump spring_version from 5.3.34 to 5.3.35 ([#4352](https://github.com/opensearch-project/security/pull/4352))
...
* Bump com.nimbusds:nimbus-jose-jwt from 9.39.1 to 9.39.3 ([#4396](https://github.com/opensearch-project/security/pull/4396))
...
* Bump spring_version from 5.3.35 to 5.3.36 ([#4368](https://github.com/opensearch-project/security/pull/4368))
...
* Adds 1.3.17.0 release notes ([#4385](https://github.com/opensearch-project/security/pull/4385))
