...
public class AnonymousAuthenticationTest {
	...
	*/
	private static final RolesMapping ANONYMOUS_USER_CUSTOM_ROLE_MAPPING = new RolesMapping(ANONYMOUS_USER_CUSTOM_ROLE)
	...
	*/
	private static final TestSecurityConfig.User EXISTING_USER = new TestSecurityConfig.User("existing_user")
			.roles(new TestSecurityConfig.Role("existing_user"));

	/**
	* User who is not stored in the internal user database and can not authenticate
	*/
	private static final TestSecurityConfig.User NOT_EXISTING_USER = new TestSecurityConfig.User("not_existing_user")
			.roles(new TestSecurityConfig.Role("not_existing_user"));
