...
public class SnapshotAuthorizationIntTests {
    ...
    static final TestIndex index_c1 = TestIndex.name("index_cr1").documentCount(7).seed(7).build();
    static final TestIndex index_hidden = TestIndex.name("index_hidden").hidden().documentCount(1).seed(8).build();
    static final TestIndex index_hidden_dot = TestIndex.name(".index_hidden_dot").hidden().documentCount(1).seed(9).build();
    static final TestIndex system_index_plugin = TestIndex.name(".system_index_plugin").hidden().documentCount(1).seed(10).build();
    ...
    static TestSecurityConfig.User LIMITED_USER_B_SYSTEM_INDEX = new TestSecurityConfig.User("limited_user_B_system_index")//
        ...
        .indexMatcher("read", limitedTo(index_b1, index_b2, index_bwx1, index_bwx2, system_index_plugin))//
