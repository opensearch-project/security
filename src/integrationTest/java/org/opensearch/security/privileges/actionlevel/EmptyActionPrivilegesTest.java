...
public class EmptyActionPrivilegesTest {
    ...
    @Test
    public void hasIndexPrivilegeForAnyIndex() {
        PrivilegesEvaluatorResponse result = subject.hasIndexPrivilegeForAnyIndex(ctx().get(), Set.of("indices:data/write/index"));
        assertThat(result, isForbidden());
    }
}
