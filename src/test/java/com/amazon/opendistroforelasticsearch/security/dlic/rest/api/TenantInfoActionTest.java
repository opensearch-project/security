...
public class TenantInfoActionTest extends AbstractRestApiUnitTest {
    ...
    public void testTenantInfoAPI() throws Exception {
        ...
        response = rh.executePatchRequest("/_opendistro/_security/api/securityconfig", "[{\"op\": \"add\",\"path\": \"/config/dynamic/openSearchDashboards/opendistro_role\",\"value\": \"opendistro_security_internal\"}]", new Header[0]);
        Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
