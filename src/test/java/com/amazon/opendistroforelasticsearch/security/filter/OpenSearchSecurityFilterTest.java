...
public class OpenSearchSecurityFilterTest {

    private final Settings settings;
    private final WildcardMatcher expected;

    public OpenSearchSecurityFilterTest(Settings settings, WildcardMatcher expected) {
    ...
    public void testImmutableIndicesWildcardMatcher() {
        final OpenSearchSecurityFilter filter = new OpenSearchSecurityFilter(
                mock(Client.class),
                settings,
