...
public class AdvancedSecurityMigrationTests extends SingleClusterTest {
    ...
    public void testPluginEnabledDataNodeWithSSlOnlyMasterNode_ReqOnAdvSecNode() throws Exception {
        ...
        setupGenericNodes(Arrays.asList(sslOnlySettings, advSecSettings, sslOnlySettings, advSecSettings),
                Arrays.asList(true, false, true, false), ClusterConfiguration.ONE_MASTER_THREE_DATA);
        Thread.sleep(10000);
    ...
    public void testPluginEnabledMasterNodeWithSSlOnlyDataNode_ReqOnAdvSecNode() throws Exception {
        ...
        setupGenericNodes(Arrays.asList(advSecSettings, advSecSettings, sslOnlySettings, sslOnlySettings),
                Arrays.asList(false, false, true, true), ClusterConfiguration.ONE_MASTER_THREE_DATA);
        Thread.sleep(10000);
    ...
    public void testPluginEnabledMasterNodeWithDisabledDataNode_ReqOnDisabledNode() throws Exception {
        ...
        setupGenericNodes(Arrays.asList(advSecSettings, disabledSettings, disabledSettings, advSecSettings),
                Arrays.asList(false, false, false, false), ClusterConfiguration.ONE_MASTER_THREE_DATA);
        Thread.sleep(10000);
    ...
    public void testPluginEnabledMasterNodeWithDisabledDataNode_ReqOnAdvSecNode() throws Exception {
        ...
        setupGenericNodes(Arrays.asList(advSecSettings, advSecSettings, disabledSettings, advSecSettings),
                Arrays.asList(false, false, false, false), ClusterConfiguration.ONE_MASTER_THREE_DATA);
        Thread.sleep(10000);
    ...
    public void testWithPassiveAuthDisabled() throws Exception {
        final Settings advSecSettings = getAdvSecSettings()
                .put(ConfigConstants.OPENDISTRO_SECURITY_UNSUPPORTED_PASSIVE_INTERTRANSPORT_AUTH_INITIALLY, false)
                .build();
        final Settings sslOnlySettings = getSSLOnlyModeSettings().build();
    ...
    private Settings.Builder getAdvSecSettings() {
        return Settings.builder()
                ...
                .put(ConfigConstants.OPENDISTRO_SECURITY_UNSUPPORTED_PASSIVE_INTERTRANSPORT_AUTH_INITIALLY, true)
