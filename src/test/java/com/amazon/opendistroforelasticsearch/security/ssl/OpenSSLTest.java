...
public class OpenSSLTest extends SSLTest {
    ...
    public void testNodeClientSSLwithOpenSslTLSv13() throws Exception {
        ...
        final Settings settings = Settings.builder().put("security.ssl.transport.enabled", true)
                ...
                .put("security.ssl.transport.keystore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("ssl/node-0-keystore.jks"))
                .put("security.ssl.transport.truststore_filepath", FileHelper.getAbsoluteFilePathFromClassPath("ssl/truststore.jks"))
                .put("security.ssl.transport.enforce_hostname_verification", false)
                .put("security.ssl.transport.resolve_hostname", false)
