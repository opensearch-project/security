...
public class ConfigTests {
    ...
    private void check(String file, CType cType) throws Exception {
        ...
        SecurityDynamicConfiguration<?> conf = SecurityDynamicConfiguration.fromJson(jsonSerialize, cType, configVersion, -1, 0, 0);
        SecurityDynamicConfiguration.fromJson(Strings.toString(conf), cType, configVersion, -1, 0, 0);
