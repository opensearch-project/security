...
public class MultitenancyTests extends SingleClusterTest {
    ...
    public void testMt() throws Exception {
        ...
        Assert.assertTrue(WildcardMatcher.pattern("*.kibana_*_humanresources*").test(res.getBody()));
        ...
        System.out.println(res.getBody());
        Assert.assertTrue(WildcardMatcher.pattern("*human_resources*").test(res.getBody()));
