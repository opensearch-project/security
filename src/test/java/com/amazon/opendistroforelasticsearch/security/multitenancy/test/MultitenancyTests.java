...
public class MultitenancyTests extends SingleClusterTest {
    ...
    public void testMt() throws Exception {
        ...
        Assert.assertEquals(".kibana_1592542611_humanresources_1", DefaultObjectMapper.objectMapper.readTree(res.getBody()).get("_index").asText());
        ...
        System.out.println(res.getBody());
        Assert.assertNotNull(DefaultObjectMapper.objectMapper.readTree(res.getBody()).get(".kibana_1592542611_humanresources_1").get("aliases").get(".kibana_1592542611_humanresources"));
