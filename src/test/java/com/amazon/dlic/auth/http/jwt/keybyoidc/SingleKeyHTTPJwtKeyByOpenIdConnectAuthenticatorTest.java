...
public class SingleKeyHTTPJwtKeyByOpenIdConnectAuthenticatorTest {
    ...
    public void wrongSigTest() throws Exception {
        ...
        try {
            ...
            AuthCredentials creds = jwtAuth.extractCredentials(
                new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_X), new HashMap<String, String>()).asSecurityRequest(),
                null
            );
    ...
    public void mismatchedAlgTest() throws Exception {
        ...
        try {
            ...
            AuthCredentials creds = jwtAuth.extractCredentials(
                new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_1), new HashMap<String, String>()).asSecurityRequest(),
                null
            );
    ...
    public void keyExchangeTest() throws Exception {
        ...
        try {
            ...
            creds = jwtAuth.extractCredentials(
                new FakeRestRequest(ImmutableMap.of("Authorization", TestJwts.NoKid.MC_COY_SIGNED_RSA_2), new HashMap<String, String>()).asSecurityRequest(),
                null
            );
