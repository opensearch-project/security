...
package com.amazon.opendistrosecurity.test.plugin;
...
public class UserInjectorPlugin extends Plugin implements NetworkPlugin {
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        httpTransports.put("com.amazon.opendistrosecurity.http.UserInjectingServerTransport", () -> new UserInjectingServerTransport(settings, networkService, bigArrays, threadPool, xContentRegistry, validatingDispatcher));        
