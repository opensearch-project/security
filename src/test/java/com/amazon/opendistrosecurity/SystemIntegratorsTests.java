...
public class SystemIntegratorsTests extends SingleClusterTest {
    ...
    public void testInjectedUserMalformed() throws Exception {
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, null));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "|||"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());
        
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "||127.0.0:80|"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());
        
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "username||ip|"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "username||ip:port|"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "username||ip:80|"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "username||127.0.x:80|"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "username||127.0.0:80|key1,value1,key2"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());

        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "||127.0.0:80|key1,value1,key2,value2"));
        Assert.assertEquals(HttpStatus.SC_UNAUTHORIZED, resc.getStatusCode());
    ...
    public void testInjectedUser() throws Exception {
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "admin||127.0.0:80|"));
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "admin|role1|127.0.0:80|key1,value1"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "admin|role1,role2||key1,value1"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "admin|role1,role2|8.8.8.8:8|key1,value1,key2,value2"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        Assert.assertTrue(resc.getBody().contains("User [name=admin, roles=[role1, role2], requestedTenant=null]"));
        // remote IP is assigned by XFFResolver
        Assert.assertFalse(resc.getBody().contains("\"remote_address\":null"));
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "nagilum|role1,role2|8.8.8.8:8|key1,value1,key2,value2"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        ...
        Assert.assertTrue(resc.getBody().contains("\"backend_roles\":[\"role1\",\"role2\"]"));
        // mapped by username
        Assert.assertTrue(resc.getBody().contains("\"roles\":[\"sg_all_access\""));
        Assert.assertTrue(resc.getBody().contains("\"custom_attribute_names\":[\"key1\",\"key2\"]"));
        
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "myuser|role1,vulcanadmin|8.8.8.8:8|key1,value1,key2,value2"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        ...
        Assert.assertTrue(resc.getBody().contains("\"roles\":[\"sg_public\",\"sg_role_vulcans_admin\"]"));
        Assert.assertTrue(resc.getBody().contains("\"custom_attribute_names\":[\"key1\",\"key2\"]"));
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "myuser|role1,vulcanadmin|8.8.8.8:8|key1,value1,key2,value2|mytenant"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
        ...
        resc = rh.executeGetRequest("_opendistro/_security/authinfo", new BasicHeader(ConfigConstants.SG_INJECTED_USER, "myuser|role1,vulcanadmin|8.8.8.8:8||mytenant with whitespace"));
        Assert.assertEquals(HttpStatus.SC_OK, resc.getStatusCode());
