...
public class SecurityIndexAccessEvaluatorTest {
    ...
    @Mock
    ExtensionsManager extensionsManagerMock;
    ...
    public void setup(
        ...
        try {
            ...
            Constructor<ConfigModelV7.SecurityRoles> constructor = (Constructor<
                ConfigModelV7.SecurityRoles>) ConfigModelV7.SecurityRoles.class.getDeclaredConstructors()[0];
            constructor.setAccessible(true);
            securityRoles = constructor.newInstance(null, 1);
        ...
        Field field;
        try {
            field = OpenSearchSecurityPlugin.GuiceHolder.class.getDeclaredField("extensionsManager");
            field.setAccessible(true);
            field.set(null, extensionsManagerMock);
        } catch (NoSuchFieldException | IllegalAccessException e) {
            throw new RuntimeException(e);
        }
        when(extensionsManagerMock.lookupExtensionSettingsById(user.getName())).thenReturn(Optional.empty());
