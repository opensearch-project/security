...
public class RestLayerPrivilegesEvaluatorTest {
    ...
    private RestLayerPrivilegesEvaluatorImpl privilegesEvaluator;

    private static final User TEST_USER = new User("test_user");

    private void setLoggingLevel(final Level level) {
        final Logger restLayerPrivilegesEvaluatorLogger = LogManager.getLogger(RestLayerPrivilegesEvaluatorImpl.class);
    ...
    public void setUp() {
        ...
        privilegesEvaluator = new RestLayerPrivilegesEvaluatorImpl(
                clusterService,
                threadPool
        );
    ...
    public void testEvaluate_NotInitialized_NullModel_ExceptionThrown() {
        ...
        final OpenSearchSecurityException exception = assertThrows(
            ...
            () -> privilegesEvaluator.evaluate(TEST_USER, null, Set.of(""))
        );
