...
public class ConfigurationRepositoryTest {
  ...
  public void getConfiguration_withValidConfigurationShouldReturnDeepClone() throws IOException {
    ...
    when(configRepository.getConfiguration(CType.ROLES)).thenReturn(SecurityDynamicConfiguration
        .fromJson(objectMapper.writeValueAsString(objectNode), CType.ROLES, 2, 1, 1));
