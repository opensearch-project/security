...
public class SecurityRestFilterTest extends AbstractRestApiUnitTest {
     ...
     */
    private final Header adminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("admin_all_access", "admin_all_access");
    private final Header nonAdminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("sarek", "sarek");
