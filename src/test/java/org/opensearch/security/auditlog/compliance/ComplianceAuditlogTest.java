...
public class ComplianceAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testSourceFilter() throws Exception {
        ...
        RestHelper.HttpResponse response = rh.executePostRequest("_search?pretty", search, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
    ...
    public void testSourceFilterMsearch() throws Exception {
        ...
        TestAuditlogImpl.clear();
        RestHelper.HttpResponse response = rh.executePostRequest("_msearch?pretty", search, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
    ...
    public void testInternalConfig() throws Exception {
        ...
        RestHelper.HttpResponse response = rh.executeGetRequest("_search?pretty", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
        Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
        Thread.sleep(1500);
        System.out.println(TestAuditlogImpl.sb.toString());
    ...
    public void testUpdate() throws Exception {
        ...
        RestHelper.HttpResponse response = rh.executePostRequest("humanresources/employees/100/_update?pretty", body, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
        Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
        System.out.println(response.getBody());
        Thread.sleep(1500);
    ...
    public void testUpdatePerf() throws Exception {
        ...
        for(int i=0; i<1; i++) {
            RestHelper.HttpResponse response = rh.executePostRequest("humanresources/employees/"+i+"", "{\"customer\": {\"Age\":"+i+"}}", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
            Assert.assertEquals(HttpStatus.SC_CREATED, response.getStatusCode());
            response = rh.executePostRequest("humanresources/employees/"+i+"", "{\"customer\": {\"Age\":"+(i+2)+"}}", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
            Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
            response = rh.executePostRequest("humanresources/employees/"+i+"/_update?pretty", "{\"doc\": {\"doesel\":"+(i+3)+"}}", AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
            Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
        }
    ...
    public void testWriteHistory() throws Exception {
        ...
        body = "{\"Age\":555}";
        TestAuditlogImpl.clear();
        response = rh.executePostRequest("humanresources/employees/100?pretty", body, AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin"));
        Assert.assertEquals(HttpStatus.SC_OK, response.getStatusCode());
        System.out.println(response.getBody());
        Thread.sleep(1500);
        System.out.println(TestAuditlogImpl.sb.toString());
