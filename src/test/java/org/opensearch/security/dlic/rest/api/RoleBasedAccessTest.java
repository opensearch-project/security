...
public class RoleBasedAccessTest extends AbstractRestApiUnitTest {
    ...
    public void testActionGroupsApi() throws Exception {
        ...
        assertThat(settings.getAsList("opendistro_security_all_access.users").get(0), "nagilum", is(""));
        assertThat(settings.getAsList("opendistro_security_role_starfleet_library.backend_roles").get(0), "starfleet*", is(""));
        assertThat(settings.getAsList("opendistro_security_zdummy_all.users").get(0), "bug108", is(""));
