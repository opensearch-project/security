...
public class NodesDnApiTest extends AbstractRestApiUnitTest {
    ...
    public void testNodesDnApi() throws Exception {
        ...
        final Header adminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("admin", "admin");
        final Header nonAdminCredsHeader = AbstractSecurityUnitTest.encodeBasicHeader("sarek", "sarek");
