...
/**
 * FIPS variant of {@link LdapBackendTestNewStyleConfig}. Everything except the SSLv3 case behaves identically under the BC FIPS
 * providers, so only that one is overridden.
 */
public class LdapBackendTestNewStyleConfigFipsTests extends LdapBackendTestNewStyleConfig {
