...
public abstract class TransportNodesAsyncAction<
     ...
     */
    protected TransportNodesAsyncAction(
        String actionName,
    ...
    protected abstract void nodeOperation(NodeRequest request, ActionListener<NodeResponse> listener);
    ...
    class NodeTransportHandler implements TransportRequestHandler<NodeRequest> {
        ...
        public void messageReceived(NodeRequest request, TransportChannel channel, Task task) throws Exception {
            nodeOperation(request, new ChannelActionListener<>(channel, actionName, request));
        }
    }
