...
public enum ModuleType implements Serializable {
	...
	REST_MANAGEMENT_API("REST Management API", "org.opensearch.security.dlic.rest.api.OpenDistroSecurityRestApiActions", Boolean.TRUE),
	DLSFLS("Document- and Field-Level Security", "org.opensearch.security.configuration.OpenDistroSecurityFlsDlsIndexSearcherWrapper", Boolean.TRUE),
