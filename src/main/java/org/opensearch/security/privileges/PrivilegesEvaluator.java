...
public class PrivilegesEvaluator {
    ...
    private void setUserInfoInThreadContext(User user, Set<String> mappedRoles) {
        if (threadContext.getTransient(ConfigConstants.OPENDISTRO_SECURITY_USER_INFO_THREAD_CONTEXT) == null) {
            ...
            threadContext.putTransient(ConfigConstants.OPENDISTRO_SECURITY_USER_INFO_THREAD_CONTEXT, joiner.toString());
        }
    }
    ...
    public String kibanaRole() {
        return dcm.getKibanaRole();
    }
