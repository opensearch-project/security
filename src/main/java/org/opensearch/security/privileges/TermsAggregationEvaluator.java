...
public class TermsAggregationEvaluator {
    ...
    public PrivilegesEvaluatorResponse evaluate(final IndexResolverReplacer.Resolved resolved, final ActionRequest request, ClusterService clusterService, User user, SecurityRoles securityRoles, IndexNameExpressionResolver resolver, PrivilegesEvaluatorResponse presponse) {
        try {
