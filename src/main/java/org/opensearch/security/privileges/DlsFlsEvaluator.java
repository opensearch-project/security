...
public class DlsFlsEvaluator {
    ...
    public PrivilegesEvaluatorResponse evaluate(final ActionRequest request, final ClusterService clusterService, final IndexNameExpressionResolver resolver, final IndexResolverReplacer.Resolved requestedResolved, final User user,
