...
public class DlsRestriction extends AbstractRuleBasedPrivileges.Rule {
    ...
    public static final DlsRestriction FULL = new DlsRestriction(ImmutableList.of(new MatchNoneQueryBuilder()));
    ...
    DlsRestriction(List<QueryBuilder> queries) {
    ...
    public ImmutableList<QueryBuilder> getQueries() {
        return queries;
    }
}
