...
public final class SSLConfigConstants {
    ...
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMTRUSTEDCAS_FILEPATH = SSL_TRANSPORT_SERVER_PREFIX + PEM_TRUSTED_CAS_FILEPATH;
    ...
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMTRUSTEDCAS_FILEPATH = SSL_TRANSPORT_CLIENT_PREFIX + PEM_TRUSTED_CAS_FILEPATH;
