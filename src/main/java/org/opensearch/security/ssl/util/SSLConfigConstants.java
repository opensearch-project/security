...
public final class SSLConfigConstants {
    ...
    public static final String SECURITY_SSL_TRANSPORT_SERVER_KEYSTORE_KEYPASSWORD =
        "plugins.security.ssl.transport.server.keystore_keypassword";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_KEYSTORE_KEYPASSWORD =
