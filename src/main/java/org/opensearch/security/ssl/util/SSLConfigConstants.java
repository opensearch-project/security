...
public final class SSLConfigConstants {
    ...
    public static final String SECURITY_SSL_HTTP_PEMKEY_FILEPATH = SSL_HTTP_PREFIX + "pemkey_filepath";
    public static final String SECURITY_SSL_HTTP_PEMCERT_FILEPATH = SSL_HTTP_PREFIX + "pemcert_filepath";
    ...
    public static final String SECURITY_SSL_HTTP_CRL_DISABLE_OCSP = SSL_HTTP_PREFIX + "crl.disable_ocsp";
    public static final String SECURITY_SSL_HTTP_CRL_DISABLE_CRLDP = SSL_HTTP_PREFIX + "crl.disable_crldp";
    public static final String SECURITY_SSL_HTTP_CRL_VALIDATION_DATE = SSL_HTTP_PREFIX + "crl.validation_date";
    ...
    public static final String SECURITY_SSL_TRANSPORT_PEMKEY_FILEPATH = SSL_TRANSPORT_PREFIX + "pemkey_filepath";
    public static final String SECURITY_SSL_TRANSPORT_PEMCERT_FILEPATH = SSL_TRANSPORT_PREFIX + "pemcert_filepath";
    ...
    public static final String SECURITY_SSL_TRANSPORT_SERVER_KEYSTORE_ALIAS = SSL_TRANSPORT_PREFIX + "server.keystore_alias";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMKEY_FILEPATH = SSL_TRANSPORT_PREFIX + "server.pemkey_filepath";
    public static final String SECURITY_SSL_TRANSPORT_SERVER_PEMCERT_FILEPATH = SSL_TRANSPORT_PREFIX + "server.pemcert_filepath";
    ...
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMKEY_FILEPATH = SSL_TRANSPORT_PREFIX + "client.pemkey_filepath";
    public static final String SECURITY_SSL_TRANSPORT_CLIENT_PEMCERT_FILEPATH = SSL_TRANSPORT_PREFIX + "client.pemcert_filepath";
