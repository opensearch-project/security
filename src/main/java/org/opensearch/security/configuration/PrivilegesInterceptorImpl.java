...
public class PrivilegesInterceptorImpl extends PrivilegesInterceptor {
    ...
    public ReplaceResult replaceKibanaIndex(final ActionRequest request, final String action, final User user, final DynamicConfigModel config,
                                            final IndexResolverReplacer.Resolved requestedResolved, final Map<String, Boolean> tenants) {
    ...
    private static boolean resolveToKibanaIndexOrAlias(final IndexResolverReplacer.Resolved requestedResolved, final String kibanaIndexName) {
