...
/**
 * This class represents a request to list accessible resources.
 *
...
public class ListAccessibleResourcesRequest extends ActionRequest {
     ...
     */
    private ListAccessibleResourcesRequest(Builder builder) {
    ...
    /**
     * Static factory method to initialize ListAccessibleResourceRequest from a Map.
     */
    @SuppressWarnings("unchecked")
    public static ListAccessibleResourcesRequest from(Map<String, Object> source, Map<String, String> params) throws IOException {
    ...
    public ListAccessibleResourcesRequest(StreamInput in) throws IOException {
        super(in);
    ...
    /**
     * Builder for ListAccessibleResourceRequest
     */
    public static class Builder {
        ...
        public ListAccessibleResourcesRequest build() {
            ...
            return new ListAccessibleResourcesRequest(this);
        }
    }
}
