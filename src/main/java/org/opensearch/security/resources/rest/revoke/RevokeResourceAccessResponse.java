...
/**
 * This class is used to represent the response of a {@link RevokeResourceAccessRequest}.
 *
...
public class RevokeResourceAccessResponse extends ActionResponse implements ToXContentObject {
    ...
    public RevokeResourceAccessResponse(ResourceSharing resourceSharing) {
    ...
    public String toString() {
        return "RevokeResourceAccessResponse [resourceSharing=" + resourceSharing + "]";
    }
}
