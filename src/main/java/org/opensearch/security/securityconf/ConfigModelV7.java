...
public class ConfigModelV7 extends ConfigModel {
    ...
    public static class SecurityRoles implements org.opensearch.security.securityconf.SecurityRoles {
      ...
      //kibana special only, terms eval
        ...
        //rolespan
        public boolean impliesTypePermGlobal(IndexResolverReplacer.Resolved resolved, User user, String[] actions, IndexNameExpressionResolver resolver,
                                             ClusterService cs) {
    ...
    public static class SecurityRole {
        ...
        private Set<String> getAllResolvedPermittedIndices(IndexResolverReplacer.Resolved resolved, User user, String[] actions, IndexNameExpressionResolver resolver,
                                                           ClusterService cs) {
...
//                return false;
    ...
    private static boolean impliesTypePerm(Set<IndexPattern> ipatterns, IndexResolverReplacer.Resolved resolved, User user, String[] requestedActions,
