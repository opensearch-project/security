...
public class ConfigV7 {
    ...
    private static class AuthcBackendSerializer extends StdSerializer<AuthcBackend> {

        public AuthcBackendSerializer() {
            this(null);
        }

        public AuthcBackendSerializer(Class<AuthcBackend> t) {
            super(t);
        }

        @Override
        public void serialize(AuthcBackend value, JsonGenerator gen, SerializerProvider provider) throws IOException {
