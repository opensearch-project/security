...
public class NetworkModule extends AbstractModule {
    ...
    private Class transportIntercetor = NOOP.class;
      
    public static class NOOP implements TransportInterceptor {
    ...
    protected void configure() {
        ...
        bind(TransportInterceptor.class).to(transportIntercetor);
     ...
     */
    public void setTransportInterceptor(Class interceptor) {
        this.transportIntercetor = Objects.requireNonNull(interceptor, "interceptor must not be null");
    }
