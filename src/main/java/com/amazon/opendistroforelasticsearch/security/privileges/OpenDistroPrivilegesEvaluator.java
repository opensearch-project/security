...
public class OpenDistroPrivilegesEvaluator extends AbstractPrivilegesEvaluator {
    ...
    public OpenDistroPrivilegesEvaluator(final ClusterService clusterService, final ThreadPool threadPool,
