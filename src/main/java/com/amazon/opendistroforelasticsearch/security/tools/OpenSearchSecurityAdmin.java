...
public class OpenSearchSecurityAdmin {
    ...
    public static int execute(final String[] args) throws Exception {
        ...
        System.out.println("OpenSearch Security Admin v7");
        ...
        options.addOption(Option.builder("us").longOpt("update_settings").hasArg().argName("number of replicas").desc("Update the number of OpenSearch Security index replicas, reload configuration on all nodes and exit").build());
        ...
        options.addOption(Option.builder("rl").longOpt("reload").desc("Reload the configuration on all nodes, flush all OpenSearch Security caches and exit").build());
