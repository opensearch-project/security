...
public class NodesDnApiAction extends PatchableResourceApiAction {
    ...
    public NodesDnApiAction(final Settings settings, final Path configPath, final RestController controller, final Client client,
                            ...
                            final PrincipalExtractor principalExtractor, final PrivilegesEvaluator evaluator, final SpecialPrivilegesEvaluationContextProviderRegistry specialPrivilegesEvaluationContextProviderRegistry,
