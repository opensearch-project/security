...
public class OpenSearchSecurityConfigAction extends PatchableResourceApiAction {
    ...
    @Inject
    public OpenSearchSecurityConfigAction(final Settings settings, final Path configPath, final RestController controller, final Client client,
