...
public class ConfigModelV7 extends ConfigModel {
        ...
        for (Entry<String, RoleV7> securityRole : settings.getCEntries().entrySet()) {
            ...
            Future<SecurityRole> future = execs.submit(new Callable<SecurityRole>() {
                ...
                public SecurityRole call() throws Exception {
                    ...
                    final Set<String> permittedClusterActions =
                            agr.resolvedActions(securityRole.getValue().getCluster_permissions());
                            ...
                            for (RoleV7.Tenant tenant : tenants) {
                                ...
                                for (String matchingTenant : WildcardMatcher.getMatchAny(tenant.getTenant_patterns(),
                                    ...
                                    tuples.add(new Tuple<String, Boolean>(matchingTenant,
                                            agr.resolvedActions(tenant.getAllowed_actions()).contains("kibana:saved_objects" +
                                                    "/*/write")));
                                }
                            }
                        }
    ...
    private class RoleMappingHolder {
        ...
        private RoleMappingHolder(final SecurityDynamicConfiguration<RoleMappingsV7> rolemappings,
