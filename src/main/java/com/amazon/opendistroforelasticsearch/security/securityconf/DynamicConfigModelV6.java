...
import com.amazon.opendistroforelasticsearch.security.securityconf.impl.v6.ConfigV6.Authc;
import com.amazon.opendistroforelasticsearch.security.securityconf.impl.v6.ConfigV6.AuthcDomain;
import com.amazon.opendistroforelasticsearch.security.securityconf.impl.v6.ConfigV6.Authz;
import com.amazon.opendistroforelasticsearch.security.securityconf.impl.v6.ConfigV6.AuthzDomain;
...
public class DynamicConfigModelV6 extends DynamicConfigModel {
    ...
    public boolean isDnfofEnabled() {
        return config.dynamic.do_not_fail_on_forbidden || config.dynamic.openSearchDashboards.do_not_fail_on_forbidden;
    }
    @Override
