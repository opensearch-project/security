...
public interface SecurityRoles {
    ...
    Set<String> getAllPermittedIndicesForOpenSearchDashboards(Resolved resolved, User user, String[] actions, IndexNameExpressionResolver resolver, ClusterService cs);
