...
public class AuditConfig {
    ...
    public static class Filter {
        ...
        public static Filter fromConfig(final Settings configuration) {
            ...
            final Set<AuditCategory> disabledRestCategories = AuditCategory.parse(configuration.getAsList("disabled_rest_categories", ConfigConstants.OPENDISTRO_SECURITY_AUDIT_DISABLED_CATEGORIES_DEFAULT));
            final Set<AuditCategory> disabledTransportCategories = AuditCategory.parse(configuration.getAsList("disabled_transport_categories", ConfigConstants.OPENDISTRO_SECURITY_AUDIT_DISABLED_CATEGORIES_DEFAULT));
