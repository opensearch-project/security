...
public class OpenSearchSecurityHttpServerTransport extends OpenSearchSecuritySSLNettyHttpServerTransport {
    ...
    public OpenSearchSecurityHttpServerTransport(final Settings settings, final NetworkService networkService,
                                                 final BigArrays bigArrays, final ThreadPool threadPool, final OpenSearchSecurityKeyStore odsks,
