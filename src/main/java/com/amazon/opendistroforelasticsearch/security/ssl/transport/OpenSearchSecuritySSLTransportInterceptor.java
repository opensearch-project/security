...
public final class OpenSearchSecuritySSLTransportInterceptor implements TransportInterceptor {
    ...
    public <T extends TransportRequest> TransportRequestHandler<T> interceptHandler(String action, String executor, boolean forceExecution,
        ...
        return new OpenSearchSecuritySSLRequestHandler<T>(action, actualHandler, threadPool, principalExtractor, errorHandler);
    }
