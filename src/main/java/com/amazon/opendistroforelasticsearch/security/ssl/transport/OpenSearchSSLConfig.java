...
public class OpenSearchSSLConfig {
    ...
    private static final Logger logger = LogManager.getLogger(OpenSearchSSLConfig.class);

    private final boolean sslOnly;
    private volatile boolean dualModeEnabled;

    public OpenSearchSSLConfig(final boolean sslOnly, final boolean dualModeEnabled) {
    ...
    public OpenSearchSSLConfig(final Settings settings) {
