 ...
 */
public class OpenSearchSecuritySSLCertsInfoAction extends BaseRestHandler {
    ...
    private OpenSearchSecurityKeyStore odsks;
    private AdminDNs adminDns;
    private ThreadContext threadContext;

    public OpenSearchSecuritySSLCertsInfoAction(final Settings settings,
                                                final RestController restController,
                                                final OpenSearchSecurityKeyStore odsks,
