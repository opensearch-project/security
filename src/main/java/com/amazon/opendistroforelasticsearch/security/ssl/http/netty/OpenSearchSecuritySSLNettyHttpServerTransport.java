...
public class OpenSearchSecuritySSLNettyHttpServerTransport extends Netty4HttpServerTransport {

    private static final Logger logger = LogManager.getLogger(OpenSearchSecuritySSLNettyHttpServerTransport.class);
    private final OpenSearchSecurityKeyStore odsks;
    private final SslExceptionHandler errorHandler;
    
    public OpenSearchSecuritySSLNettyHttpServerTransport(final Settings settings, final NetworkService networkService, final BigArrays bigArrays,
                                                         final ThreadPool threadPool, final OpenSearchSecurityKeyStore odsks, final NamedXContentRegistry namedXContentRegistry, final ValidatingDispatcher dispatcher,
    ...
    protected class SSLHttpChannelHandler extends Netty4HttpServerTransport.HttpChannelHandler {
        ...
        protected SSLHttpChannelHandler(Netty4HttpServerTransport transport, final HttpHandlingSettings handlingSettings, final OpenSearchSecurityKeyStore odsks) {
        ...
        protected void initChannel(Channel ch) throws Exception {
            ...
            final SslHandler sslHandler = new SslHandler(OpenSearchSecuritySSLNettyHttpServerTransport.this.odsks.createHTTPSSLEngine());
