...
public class ExternalOpenSearchSecurityKeyStore implements OpenSearchSecurityKeyStore {
    ...
    public ExternalOpenSearchSecurityKeyStore(final Settings settings) {
