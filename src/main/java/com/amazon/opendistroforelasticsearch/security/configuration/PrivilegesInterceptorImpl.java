...
public class PrivilegesInterceptorImpl extends PrivilegesInterceptor {
    ...
    private boolean isTenantAllowed(final ActionRequest request, final String action, final User user,
                                    SecurityRoles securityRoles, ConfigModel configModel, final String requestedTenant) {
        ...
        SecurityRoles.TenantPermissions tenantPermissions = securityRoles.getTenantPermissions(user, requestedTenant);
