...
public class OpenSearchSecurityFlsDlsIndexSearcherWrapper extends OpenSearchSecurityIndexSearcherWrapper {
    ...
    protected DirectoryReader dlsFlsWrap(final DirectoryReader reader, boolean isAdmin) throws IOException {
        ...
        if(!isAdmin) {
            ...
            final String flsEval = OpenSearchSecurityUtils.evalMap(allowedFlsFields, index.getName());
            final String dlsEval = OpenSearchSecurityUtils.evalMap(queries, index.getName());
            final String maskedEval = OpenSearchSecurityUtils.evalMap(maskedFieldsMap, index.getName());
