...
public class OpenSearchSecurityInfoAction extends BaseRestHandler {
    ...
    public OpenSearchSecurityInfoAction(final Settings settings, final RestController controller, final PrivilegesEvaluator evaluator, final ThreadPool threadPool) {
        super();
