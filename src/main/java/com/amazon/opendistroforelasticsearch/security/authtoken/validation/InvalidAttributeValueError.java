...
public class InvalidAttributeValueError extends ValidationError {
    private final Object expected;
    private final Object value;

    public InvalidAttributeValueError(String attribute, Object value, Object expected, JsonNode jsonNode) {
        super(attribute, "Invalid value", jsonNode);
        this.expected = expected;
        this.value = value;
    }

    public InvalidAttributeValueError(String attribute, Object value, Object expected, ValidatingJsonNode jsonNode) {
        this(attribute, value, expected, jsonNode.getDelegate());
    }

    public InvalidAttributeValueError(String attribute, Object value, Object expected) {
