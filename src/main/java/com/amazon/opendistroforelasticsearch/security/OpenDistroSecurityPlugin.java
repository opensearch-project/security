...
import com.amazon.opendistroforelasticsearch.security.rest.OpenSearchDashboardsInfoAction;
    ...
    public List<RestHandler> getRestHandlers(Settings settings, RestController restController, ClusterSettings clusterSettings,
        ...
        if (!client && !disabled) {
            ...
            if(!openDistroSSLConfig.isSslOnlyMode()) {
                ...
                handlers.add(new OpenSearchDashboardsInfoAction(settings, restController, Objects.requireNonNull(evaluator), Objects.requireNonNull(threadPool)));
