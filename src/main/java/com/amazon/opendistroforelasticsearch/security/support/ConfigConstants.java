...
public class ConfigConstants {
    ...
    public static final String OPENDISTRO_SECURITY_PASSIVE_INTERTRANSPORT_AUTH_INITIALLY = "opendistro_security.unsupported.passive_intertransport_auth_initially";
