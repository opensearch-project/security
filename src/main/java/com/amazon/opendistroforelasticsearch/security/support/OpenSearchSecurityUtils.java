...
public final class OpenSearchSecurityUtils {
    
    protected final static Logger log = LogManager.getLogger(OpenSearchSecurityUtils.class);
    ...
    private OpenSearchSecurityUtils() {
    }
